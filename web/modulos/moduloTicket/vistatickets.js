...
function ActualizaAlimentos() {
    ...
    obj.forEach(function(elemento) {
        ...
        registro += '<div class="codigo-qr" id="codigo_' + obj.indexOf(elemento) + '">' +
                    ...
                    '<br><br>' +
                    '<button class="btn btn-light p-3 mb-2 bg-danger-subtle text-danger-emphasis border border-light" id="btndescargar_' + obj.indexOf(elemento) + '">Descargar QR</button>' +
                 '<br><br>' +      
                '<p>'+ 'Horario: '+ hd + '</p>'+
                       '<p>Total de productos:'+tp+'</p>'+
                         '<p>'+ 'IVA : '+ IVA + '</p>'+
                         '<p>'+ 'Total a pagar : '+ tpp+ '</p>'+
                    '<a href="GestTicket.html"> <button class="btn btn-light p-3 mb-2 bg-danger-subtle text-danger-emphasis border border-light">Editar</button></a>' +
                 '<br><br>' + 
                '</div>';      
